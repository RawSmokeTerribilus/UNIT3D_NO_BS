    ...
    public function filter(Request $request): TorrentsResource|\Illuminate\Http\JsonResponse
    {
        ...
        [$torrents, $hasMore] = cache()->flexible($cacheKey, [60 * 5, 60 * 6], function () use ($request, $isSqlAllowed) {
            ...
            $filters = new TorrentSearchFiltersDTO(
                ...
                primaryLanguageNames: $request->filled('primaryLanguages') ? (array) $request->primaryLanguages : [],
                ...
                foreach ($results['hits'] ?? [] as $hit) {
                    ...
                    $torrents->push([
                        ...
                        'attributes' => [
                            ...
                            'distributor'      => $hit['distributor']['name'] ?? null,
                            ...
                            'tmdb_id'          => $hit['tmdb_movie_id'] ?: $hit['tmdb_tv_id'] ?: null,
                            'imdb_id'          => $hit['imdb'],
                            'tvdb_id'          => $hit['tvdb'],
                            'mal_id'           => $hit['mal'],
                            'igdb_id'          => $hit['igdb'],
                            ...
                            'distributor_id'   => $hit['distributor']['id'] ?? null,
                            'region_id'        => $hit['region']['id'] ?? null,
