...
# 2. Ejecuta el script
bash /home/rawserver/UNIT3D_Develop/NO_BS_meilisearch.sh local
...
**Resultado esperado:**
```
unit3d-staging-app  | ✓ Meilisearch is available. Configuring dual indexes...
unit3d-staging-app  | ✓ Meilisearch configuration completed successfully
```
...
- Acceso a UNIT3D en /home/rawserver/UNIT3D_Develop/
```
...
grep MEILISEARCH_KEY /home/rawserver/UNIT3D_Develop/docker-compose.yml
...
grep MEILISEARCH_KEY /home/rawserver/UNIT3D_Develop/.env
```
...
# ¿Qué ocurre internamente?
# ✓ Detecta que ejecutas desde host (/home/rawserver/UNIT3D_Develop)
...
docker volume rm unit3d_develop_meilisearch-data
...
# 3. Revisar volumen
docker inspect unit3d_develop_meilisearch-data
```
...
grep -A2 "environment:" /home/rawserver/UNIT3D_Develop/docker-compose.yml | grep MEILISEARCH
