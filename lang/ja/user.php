 ...
 */
    ...
    'invites-rules' => [
        'know-and-trust' => '知っている人と信頼できる人だけを招待してください。',
        'responsible' => 'あなたはあなたが招待した人に対して個人的に責任があるとみなされます。',
        'yourself' => '自分を招待しないでください。招待されたすべてのユーザーをチェックします。',
        'trade-or-sell' => '招待状を売買しないでください。',
        'caught' => 'あなたが招待した人が不正行為、取引口座、または売買/取引の招待を受けた場合は、警告が表示されます。',
    ],
    'invites-send' => '招待を送る',
    'last-login' => '前回のログイン',
    'locked' => 'ロック済み',
