 ...
 */
    ...
    'rules' => '<ul>
                                        ...
                                        <li>Kun .srt, .ico og .zip er tillatt. <b>(.zip er kun tillatt for å knytte sammen undertekster for ett språk til en hel sesongpakke.)</b></li>
                                        <li>Repiterte opplastinger av søppeltekster vil bli ansett som et brudd på reglene og kan få konsekvenser for brukeren i form av innskrenkningen i rettighetene.</li>
