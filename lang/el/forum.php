 ...
 */
    ...
    'delete-post-success' => 'Αυτή η ανάρτηση έχει πλέον διαγραφεί!',
    'edit-post-success' => 'Η ανάρτηση επεξεργάστηκε με επιτυχία!',
    'forums-post-search' => 'Αναζήτηση άρθρων',
    'forums-topic-search' => 'Αναζήτηση θέματος',
    'reply-topic-error' => 'Δεν μπορείτε να απαντήσετε σε αυτό το θέμα!',
    'reply-topic-success' => 'Η ανάρτηση δημοσιεύτηκε με επιτυχία',
    'select-all-forum' => 'Όλες οι κατηγορίες/Φόρουμ',
    'subscribe' => 'Συνεισφέρω',
    'updated-at' => 'Ενημερώθηκε στις',
    'unsubscribe' => 'Διαγραφή από την εγγραφή',
];
