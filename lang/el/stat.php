 ...
 */
    ...
    'top-bountied' => 'Κορυφαία (Κηρύγματα) Bounted',
    'top-completed' => 'Κορυφαία ολοκληρωμένα',
    'top-dead' => 'Κορυφαίοι Νεκροί',
    'top-downloaded' => 'Κορυφαία Λήψη Torrents',
    'top-downloaders' => 'Κορυφαίες λήψεις',
    'top-dying' => 'Κορυφαία βαφή',
    'top-leeched' => 'Κορυφαίοι Λήπτες',
    ...
    'pruned' => 'Κλαδευμένο',
    'real' => 'Πραγματικός',
    'updated' => '(Ενημερώνεται κάθε 10 λεπτά!)',
];
