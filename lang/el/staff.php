 ...
 */
    ...
    'blocked-ips' => 'Αποκλεισμένες IP',
    'gifts-log' => 'Αρχείο καταγραφής δώρων',
    'mass-email' => 'Μαζικό ηλεκτρονικό ταχυδρομείο',
    'media-languages-desc' => '(Γλώσσες που χρησιμοποιούνται για τη συμπλήρωση αναπτυσσόμενων μενού γλωσσών για υπότιτλους / ήχους / κ.λπ.)',
    'notes' => 'Σημειώσεις',
    'passkeys' => 'Κλειδιά πρόσβασης',
    'bon-exchange' => 'Ανταλλακτηριο ποντων',
