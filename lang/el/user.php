 ...
 */
    ...
    'invites-rules' => [
        'know-and-trust' => 'Προσκαλέστε μόνο άτομα που γνωρίζετε και εμπιστεύεστε.',
        'responsible' => 'Θα είστε προσωπικά υπεύθυνοι για αυτούς που προσκαλείτε.',
        'yourself' => 'Μην προσκαλέσετε τον εαυτό σας, ελέγχουμε κάθε προσκεκλημένο χρήστη.',
        'trade-or-sell' => 'Μην κάνετε εμπόριο ή πωλήσεις προσκλήσεων.',
        'caught' => 'Αν κάποιος που προσκάλεσε έχει συλληφθεί με εξαπάτηση, λογαριασμό διαπραγμάτευσης ή προσφορές / συναλλαγές, θα ειδοποιηθείτε.',
    ],
    ...
    'apikey' => 'Κλειδί API',
    'apikeys' => 'Κλειδιά API',
    'client-connectable-state' => 'Οχι|Ναι',
    'client-list' => 'Πελάτες και διευθύνσεις IP',
    'email-updates' => 'Ενημερώσεις μέσω ηλεκτρονικού ταχυδρομείου',
    'follow-already' => 'Ακολουθείτε ήδη αυτόν τον χρήστη',
    'follow-not-to-begin-with' => 'Δεν ακολουθείτε αυτόν τον χρήστη εξαρχής',
    'follow-revoked' => 'Δεν ακολουθείτε πλέον %s',
    'follow-user' => 'Ακολουθείτε τώρα %s',
    'follow-yourself' => 'Καλή προσπάθεια, αλλά δυστυχώς δεν μπορείς να ακολουθήσεις τον εαυτό σου.',
    'following' => 'Εξής',
    'homepage-blocks' => 'Μπλοκ αρχικής σελίδας',
    'homepage-block-chat-visible' => 'Εμφάνιση μπλοκ συνομιλίας',
    'homepage-block-featured-visible' => 'Εμφάνιση Προτεινόμενου Μπλοκ Torrents',
    'homepage-block-latest-comments-visible' => 'Εμφάνιση Τελευταίων Σχόλιων',
    'homepage-block-latest-posts-visible' => 'Εμφάνιση Τελευταίων Αναρτήσεων Μπόλκ',
    'homepage-block-latest-topics-visible' => 'Εμφάνιση Τελευταίων Θεμάτων Μπλοκ',
    'homepage-block-news-visible' => 'Εμφάνιση μπλοκ ειδήσεων',
    'homepage-block-online-visible' => 'Εμφάνιση Μπλοκ Συνδεδεμένων Χρηστών',
    'homepage-block-poll-visible' => 'Εμφάνιση Μπλοκ Δημοσκόπησης',
    'homepage-block-random-media-visible' => 'Εμφάνιση Τυχαίου Μπλοκ Πολυμέσων',
    'homepage-block-top-torrents-visible' => 'Εμφάνιση Μπλοκ Κορυφαίων Torrents',
    'homepage-block-top-users-visible' => 'Εμφάνιση Μπλοκ Κορυφαίων Χρηστών',
    'internal-releases' => 'Εσωτερικές εκδόσεις',
    'invite-already-sent' => 'Η διεύθυνση email στην οποία προσπαθείτε να στείλετε μια πρόσκληση έχει ήδη σταλεί.',
    'invite-already-used' => 'Η πρόσκληση που προσπαθείτε να στείλετε ξανά έχει ήδη χρησιμοποιηθεί.',
    'invite-expired' => 'Η πρόσκληση που προσπαθείτε να στείλετε ξανά έχει λήξει.',
    'invite-resent-success' => 'Η πρόσκληση στάλθηκε ξανά με επιτυχία!',
    'invite-sent-success' => 'Η πρόσκληση στάλθηκε με επιτυχία!',
    'invites-disabled-group' => 'Οι προσκλήσεις είναι αυτήν τη στιγμή απενεργοποιημένες για την ομάδα σας.',
    'last-action' => 'Τελευταία ενέργεια',
    'my-achievements' => 'Τα επιτεύγματά μου',
    'my-downloads' => 'Οι λήψεις μου',
    'my-playlists' => 'Οι λίστες αναπαραγωγής μου',
    'not-enough-invites' => 'Δεν έχετε αρκετές προσκλήσεις!',
    'password-resets' => 'Επαναφορές κωδικών πρόσβασης',
    'reactivate' => 'Επανενεργοποίηση',
    'report-sent' => 'Η αναφορά σας στάλθηκε με επιτυχία',
    'rsskey' => 'Κλειδί RSS',
    'rsskeys' => 'Κλειδιά RSS',
    'seedbox-added-success' => 'Το Seedbox προστέθηκε με επιτυχία!',
    'seedbox-deleted-success' => 'Το Seedbox διαγράφηκε με επιτυχία',
    ...
    'total-internal-releases' => 'Συνολικές εσωτερικές εκδόσεις',
    'total-personal-releases' => 'Συνολικές Προσωπικές Εκδόσεις',
    'two-step-auth' => [
        'title' => 'Έλεγχος ταυτότητας δύο παραγόντων',
        'totp' => 'Έλεγχος ταυτότητας με κωδικό πρόσβασης μίας χρήσης (TOTP) βάσει χρόνου',
        'email' => 'Έλεγχος ταυτότητας μέσω email',
        'totp-is-enabled' => 'Ο έλεγχος ταυτότητας TOTP είναι ενεργοποιημένος αυτήν τη στιγμή. Για να τον απενεργοποιήσετε, κάντε κλικ στο κουμπί «Απενεργοποίηση» παρακάτω.',
        'totp-is-disabled' => 'Ο έλεγχος ταυτότητας TOTP είναι αυτήν τη στιγμή απενεργοποιημένος. Για να τον ενεργοποιήσετε, κάντε κλικ στο κουμπί «Ενεργοποίηση» παρακάτω.',
        'password-confirm' => 'Απαιτείται επιβεβαίωση κωδικού πρόσβασης',
        'upon-enabling' => 'Κατά την ενεργοποίηση, θα σας ζητηθεί να εισαγάγετε έναν έγκυρο κωδικό επαλήθευσης δύο παραγόντων.',
        'complete-setup' => 'Για να ολοκληρώσετε την ενεργοποίηση του ελέγχου ταυτότητας TOTP, σαρώστε τον παρακάτω γραμμωτό κώδικα με την εφαρμογή ελέγχου ταυτότητας (Google Authenticator, Authy, BitWarden, κ.λπ.) και εισαγάγετε τον κωδικό TOTP στην παρακάτω φόρμα.',
        'confirm-code' => 'Επιβεβαίωση κωδικού TOTP',
        'recovery-code' => 'Κωδικοί ανάκτησης κωδικού πρόσβασης μίας χρήσης (TOTP) βάσει χρόνου',
        'recovery-code-description' => 'Κάντε κλικ στο κουμπί «Αποκάλυψη» για να εμφανιστούν οι κωδικοί ανάκτησης για τον λογαριασμό σας. Αποθηκεύστε αυτούς τους κωδικούς με ασφάλεια εκτός σύνδεσης σε περίπτωση που χάσετε την πρόσβαση στη συσκευή TOTP σας. Εάν πιστεύετε ότι αυτοί οι κωδικοί ενδέχεται να έχουν παραβιαστεί, κάντε κλικ στην «Επαναφορά» για να δημιουργήσετε ένα νέο σύνολο κωδικών.',
        'recovery-code-reveal' => 'Αποκαλύπτω',
        'recovery-code-reset' => 'Επαναφορά',
    ],
    'upload-snatches' => 'Μεταφόρτωση Snatches',
    'personal-releases' => 'Προσωπικές εκδόσεις',
