 ...
 */
    ...
    */
    ...
    'login' => 'Σύνδεση',
    'login-now-on' => 'Συνδεθείτε τώρα στο',
    'logout' => 'Logout',
    ...
    'email-verification-link' => 'Σας έχει σταλεί μέσω email ένας σύνδεσμος επαλήθευσης μέσω email!',
    'enter-recovery' => 'Εισαγάγετε έναν από τους κωδικούς ανάκτησης που σας έχουν δοθεί κατά την πρώτη ενεργοποίηση του ελέγχου ταυτότητας δύο παραγόντων.',
    'enter-totp' => 'Εισαγάγετε τον 6ψήφιο κωδικό ελέγχου ταυτότητας που δημιουργήθηκε από την εφαρμογή σας.',
    ...
    'totp-code' => 'Κωδικός TOTP',
    'verify' => 'Επαληθεύω',
    'verify-email' => 'Επαλήθευση ηλεκτρονικού ταχυδρομείου',
    'verifying' => 'Επαλήθευση...',
    'password-confirm-desc' => 'Επιβεβαιώστε τον κωδικό πρόσβασής σας πριν συνεχίσετε.',
];
