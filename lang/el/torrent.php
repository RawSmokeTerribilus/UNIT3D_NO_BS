 ...
 */
    ...
    'comments-left' => 'Σχόλια που έμειναν',
    'distributor' => 'Διανομέας',
    'not-personal-release' => 'Δεν είναι προσωπική έκδοση',
    'personal-release' => 'Προσωπική Απελευθέρωση',
    'postponed' => 'Αναβλήθηκε',
    'recent-bumped' => 'Πρόσφατα αναβαθμισμένο',
    'refundable' => 'Επιστρεφόμενο ποσό',
    'refunded' => 'Επιστροφή χρημάτων',
    'region' => 'Περιοχή',
    'search-by-name' => 'Αναζήτηση με όνομα',
    'season' => 'Εποχή',
    'subtitle-included' => 'Αυτό το torrent περιλαμβάνει ήδη τους ακόλουθους υπότιτλους με mux:',
    'torrents-matched' => 'Τα torrents αντιστοιχίστηκαν',
];
