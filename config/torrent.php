...
return [
    ...
    */
    ...
    'created_by'        => 'Edited by ' . env('APP_NAME_ABBR', 'NOBS'),
    ...
    */
    ...
    'comment' => 'This torrent was downloaded from ' . env('APP_NAME', 'Nuclear Order Bit Syndicate'),
