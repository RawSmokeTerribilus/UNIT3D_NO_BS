                                ...
                                <article class="chatbox-message">
                                    <header class="chatbox-message__header">
                                        <address
                                            ...
                                            :style="(message.user?.is_donor ? 'background: ' + (message.user?.donor_effect || 'url(/img/sparkels.gif) center/auto 100% repeat-x') + ';' : (message.user?.group?.effect ? 'background:' + message.user.group.effect + ';' : ''))"
                                        >
                                            <a
                                            ...
                                            >
                                                ...
                                                <img
                                                    x-show="message.user?.is_donor == 1 && message.user?.donor_badge_icon?.endsWith('.svg')"
                                                ...
                                                />
                                                <i
                                                    x-show="message.user?.is_donor == 1 && message.user?.donor_badge_icon && ! message.user?.donor_badge_icon?.endsWith('.svg')"
