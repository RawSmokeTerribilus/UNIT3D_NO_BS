            ...
            >
                ...
                <p class="form__group">
                    ...
                    <input
                        ...
                        name="can_chat"
                        value="1"
                        @checked($user->can_chat ?? $user->group->can_chat)
                    />
                ...
                <p class="form__group">
                    ...
                    <input
                        ...
                        name="can_comment"
                        value="1"
                        @checked($user->can_comment ?? $user->group->can_comment)
                    />
                ...
                <p class="form__group">
                    ...
                    <input
                        ...
                        name="can_invite"
                        value="1"
                        @checked($user->can_invite ?? $user->group->can_invite)
                    />
                ...
                <p class="form__group">
                    ...
                    <input
                        ...
                        name="can_request"
                        value="1"
                        @checked($user->can_request ?? $user->group->can_request)
                    />
                ...
                <p class="form__group">
                    ...
                    <input
                        ...
                        name="can_upload"
                        value="1"
                        @checked($user->can_upload ?? $user->group->can_upload)
                    />
